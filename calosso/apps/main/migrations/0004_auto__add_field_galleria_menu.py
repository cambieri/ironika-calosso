...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Galleria.menu'
        db.add_column(u'main_galleria', 'menu', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Galleria.menu'
        db.delete_column(u'main_galleria', 'menu')
    ...
    models = {
        ...
        u'main.galleria': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'menu': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'posizione': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
