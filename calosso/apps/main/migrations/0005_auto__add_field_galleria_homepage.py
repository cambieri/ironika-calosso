...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Galleria.homepage'
        db.add_column(u'main_galleria', 'homepage', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.Homepage']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Galleria.homepage'
        db.delete_column(u'main_galleria', 'homepage_id')
