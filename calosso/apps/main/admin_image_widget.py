...
#             basename, fileformat = os.path.splitext(filetail)
#             miniature = basename + '_' + size + fileformat
#             filename = value.path
...
#             (miniature_url, miniature_url, miniature_filename, _('Change:')))
            ...
            output.append(u' <div><a href="%s"><img src="%s" alt="%s" style="max-width:100px; max-height:100px;"></a></div>' % \
