...
config = {
    'live': {
        ...
        'django': {
            'site_name': 'ironika-calosso',
            'site_dir_name': 'ironika-calosso-live',
            'site_root': '/opt/django/sites/ironika-calosso-live/',
            'project_dir_name': 'calosso',
            'project_root': '/opt/django/sites/ironika-calosso-live/calosso/',
            'settings_module': 'calosso.settings.live'
        },
        'virtualenv': {
            'path': '/opt/django/virtualenvs/ironika-calosso-live/',
            'requirements_file': '/opt/django/sites/ironika-calosso-live/requirements/requirements_live.txt',
        },
        'git': {
            'server_name': 'origin',
            'branch_name': 'live',
        ...
        'webserver': {
            'touch_file': '/opt/django/sites/ironika-calosso-live/uwsgi/live/django_wsgi.py'
        }
    },
    'stage': {
        'server': 'root@cmbhosting.no-ip.biz',
        'django': {
            'site_name': 'ironika-calosso',
            'site_dir_name': 'ironika-calosso-stage',
            'site_root': '/opt/django/sites/ironika-calosso-stage/',
            'project_dir_name': 'calosso',
            'project_root': '/opt/django/sites/ironika-calosso-stage/calosso/',
            'settings_module': 'calosso.settings.stage'
        },
        'virtualenv': {
            'path': '/opt/django/virtualenvs/ironika-calosso-stage/',
            'requirements_file': '/opt/django/sites/ironika-calosso-stage/requirements/requirements_live.txt',
        },
        'git': {
            'server_name': 'origin',
            'branch_name': 'stage',
        ...
        'webserver': {
            'touch_file': '/opt/django/sites/ironika-calosso-stage/uwsgi/stage/django_wsgi.py'
        }
    }
}
...
def prepare_git():
    with lcd('/home/workspace-django/projects/ironika-calosso'):
        git_create_repo_param = '{"name":"ironika-calosso"}'
        ...
        local('git remote add origin git@github.com:cambieri/ironika-calosso.git')
